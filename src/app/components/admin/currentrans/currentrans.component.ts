...
@Component({
  selector: 'app-currentrans',
  templateUrl: './currentrans.component.html',
  styleUrls: ['./currentrans.component.css'],
})
export class CurrentransComponent implements OnInit {
  transactions: any[] = [];
  ...
  list() {
    this.isLoading = true;
    this.transac.current().subscribe(
      (res: any) => {
