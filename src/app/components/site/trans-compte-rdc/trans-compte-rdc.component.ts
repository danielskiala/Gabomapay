...
@Component({
  selector: 'app-trans-compte-rdc',
  templateUrl: './trans-compte-rdc.component.html',
  styleUrls: ['./trans-compte-rdc.component.css'],
})
export class TransCompteRdcComponent implements OnInit {
  user: any;
